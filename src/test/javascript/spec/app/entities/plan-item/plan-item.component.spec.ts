...
import { PlanItemComponent } from 'app/entities/plan-item/plan-item.component';
...
describe('Component Tests', () => {
    describe('PlanItem Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PlanItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.planItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
