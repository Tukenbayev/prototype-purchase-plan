...
import { PurchasePlanComponent } from 'app/entities/purchase-plan/purchase-plan.component';
...
describe('Component Tests', () => {
    describe('PurchasePlan Management Component', () => {
        let comp: PurchasePlanComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PurchasePlanComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.purchasePlans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
