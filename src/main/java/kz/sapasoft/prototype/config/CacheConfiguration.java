package kz.sapasoft.prototype.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(kz.sapasoft.prototype.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(kz.sapasoft.prototype.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
